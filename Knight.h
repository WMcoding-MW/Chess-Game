...
*  Knight:
     ...
     Actions: initalizes a Knight object by setting the colour to White or 
              black
     Assumptions: none
...
*  getSymbol:
     ...
     Assumptions: Knight has been initialized

*  canMove:
     Input: current board object, old and new x-coordinates, old and new 
            y-coordinates
     Actions: checks if a Knight on the board is allowed to move from it's
              current position into the new position proposed. This is all
              of course depending on the rules of chess. 
     Assumptions: Knight and Board objects are initialized

*  clone:                                                                      
     Input: None                                                               
     Actions: duplicates the current Knight object and returns a pointer to    
              the new one                                                      
     Assumptions: Knight is initilaized    
*/
#ifndef KNIGHT_H
#define KNIGHT_H
